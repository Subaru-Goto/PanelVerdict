...
[`panel-model-selection.md`](../docs/research/panel-model-selection.md)) is a *model* of it.
...
in the response. Prompt caching [cannot fire](../docs/research/prompt-caching.md) at our
