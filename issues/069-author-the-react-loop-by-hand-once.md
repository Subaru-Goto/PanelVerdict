...
| persistence — checkpointers, `thread_id` | yes ([046](046-analyst-threads-die-on-restart.md)) |
| middleware | yes ([052](052-the-step-budget-is-derived-arithmetic-not-a-declared-limit.md), [064](064-the-cost-ceilings.md)) |
| HITL — `interrupt_before` / `interrupt_after` | available as `create_agent` parameters |
| event streaming, per-node traces | yes (shipped; [065](065-langsmith-behind-a-flag.md)) |
