...
[eu-ai-act-applicability.md](../docs/research/eu-ai-act-applicability.md). The short form:
...
- **What does apply — and is in force since 2 Aug 2026:** the author is the **provider of
  ...
  → [The analyst never says it is an AI system](074-the-analyst-never-says-it-is-an-ai-system.md)
- **Art. 50(4) content labelling does not apply** (the guidelines exclude text available
  ...
  → [Generated text carries no machine-readable mark](075-generated-text-carries-no-machine-readable-mark.md)
