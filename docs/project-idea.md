...
1. **Advanced RAG:**
   ...
   - *Query translation:* the target-description parsing IS query translation — natural language → a typed request → structured SQL filters (self-query over the persona pool). Call it that in the writeup. Built in [007](decisions/007-build-targeting-query-translation.md).
