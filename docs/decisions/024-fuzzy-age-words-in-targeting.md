...
1. **`source_phrase` beyond traits.** Today it exists only on `TraitRequest`
   ...
   [016](https://github.com/Subaru-Goto/PanelVerdict/issues/123) said to cost out first.
...
4. **The test asserts auditability, never the numbers.** A span is present and a
   ...
   being reasonable, which is [016](https://github.com/Subaru-Goto/PanelVerdict/issues/123)'s
