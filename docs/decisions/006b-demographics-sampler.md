...
See [`docs/research/demographic-sources.md`](../research/demographic-sources.md).
...
Supersedes the per-country national-source plan above (ACS PUMS / Destatis / e-Stat) and its per-country manual downloads. Research: [`docs/research/oecd-demographic-data.md`](../research/oecd-demographic-data.md) (verified against the live OECD SDMX API).
