...
> [Map: PanelVerdict next chapter](https://github.com/Subaru-Goto/PanelVerdict/issues/122).** The author named
...
- **the simple shape wins** where a normalised or scalable one would cost more now — the
  `tests` table ([060](https://github.com/Subaru-Goto/PanelVerdict/issues/155)) is the live example.
...
- **The edge refuses, the middleware bounds.** Auth and turns-per-window are FastAPI
  ...
  the same structural finding [045](https://github.com/Subaru-Goto/PanelVerdict/issues/143)
  ...
  **This reverses a stated direction, recorded so it does not look like an oversight.** The
  ...
  feature* — is honoured in full by [063](https://github.com/Subaru-Goto/PanelVerdict/issues/158); only
  the mechanism moved.
...
- **The framework learning goal is part of the destination, not a side effect.**
  **Retired 2026-08-21** — author's direction: *"There is no learning mode, fully agentic
  ...
  [076](https://github.com/Subaru-Goto/PanelVerdict/issues/166). The original clause is
  ...
  the transferable surfaces are `PostgresSaver` ([046](https://github.com/Subaru-Goto/PanelVerdict/issues/144)),
  middleware ([052](https://github.com/Subaru-Goto/PanelVerdict/issues/149),
  [064](064-the-cost-ceilings.md)) and LangSmith ([065](https://github.com/Subaru-Goto/PanelVerdict/issues/159)) — none
...
- [Where is a hand-authored graph worth it?](067-where-is-a-hand-authored-graph-worth-it.md) —
  **the middle path, decided 2026-08-21.** `/evaluate` becomes a graph *around* the vote
  ...
  [Author the evaluate graph](https://github.com/Subaru-Goto/PanelVerdict/issues/166) +
  [The panel preview](https://github.com/Subaru-Goto/PanelVerdict/issues/167).
...
- [What does the EU AI Act actually require of PanelVerdict?](073-what-the-eu-ai-act-actually-requires.md) —
  **minimal risk; no per-step-trace duty exists, 2026-08-21.** What does bind, in force
  ...
  ([074](https://github.com/Subaru-Goto/PanelVerdict/issues/164), arguably the most urgent
  ticket on a public URL) — and plausibly Art. 50(2) machine-readable marking
  ([075](https://github.com/Subaru-Goto/PanelVerdict/issues/165), watch-and-tag). Sourced
  findings: [eu-ai-act-applicability.md](../research/eu-ai-act-applicability.md).
...
- [The cost ceilings](064-the-cost-ceilings.md) — **signed off 2026-08-04.** A **$1.00/day**
  ...
  analyst spend is unmeasured, so [070](https://github.com/Subaru-Goto/PanelVerdict/issues/161) has it.
...
- **Whether Luna enacts Big Five traits.** The panel moved to `openai/gpt-5.6-luna` on
  ...
  decides, not assumption."* [071](https://github.com/Subaru-Goto/PanelVerdict/issues/162) is the
...
- **The deploy itself, and secrets handling.** [Where can this deploy?](https://github.com/Subaru-Goto/PanelVerdict/issues/154)
...
- **Node versus Edge runtime on the frontend.** Route handlers and middleware can run on
  ...
  [059](https://github.com/Subaru-Goto/PanelVerdict/issues/154)'s platform answer.
...
- **An accessibility baseline.** Contrast, focus states, keyboard reach on the dock.
  ...
  [Restyle one component both ways](https://github.com/Subaru-Goto/PanelVerdict/issues/153), because whether
...
- **Retention once accounts exist.** [040](https://github.com/Subaru-Goto/PanelVerdict/issues/138) gave votes a
...
- **Progress UX** ([021](https://github.com/Subaru-Goto/PanelVerdict/issues/126), deferred at v1) re-scoped for a public
...
<!-- Removed: "what the demo says about itself" — the dev-vs-prod disclosure copy is owned by
     [A $0 demo page](https://github.com/Subaru-Goto/PanelVerdict/issues/156), which already requires it decided. Fog
...
- **The hand-authored ReAct exercise** —
  ...
  [076](https://github.com/Subaru-Goto/PanelVerdict/issues/166) now exercises nodes and
