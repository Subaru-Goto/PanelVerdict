...
_SYSTEM_PROMPT = (
    ...
    "decline that part. Anything you "
    ...
    "report's own arithmetic you explain in words. A grammar or wording point "
    "about a headline — which of two phrasings is standard, and why — is a "
    "general headline question: answer it. A message that mixes an outside ask "
    "with a question about this test: decline the outside part in that shape, "
