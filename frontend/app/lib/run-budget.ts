 ...
 * (backend/app/data/demo/free-delivery.json, 2026-09-01); its worst case at
 * that size is eight waves of 25 votes at the measured p99 of 14.0 s
 * (docs/research/first-full-scale-run.md), 112 s, before the translator's
 * own call. The old 60 s budget cut runs that arithmetic says are alive. */
